...
basedir = os.path.join(r"..\scripts", "dataset", "pretrain3w")

train_image_list, train_y_list,train_image_name = utils.load_images(basedir, 'train', (100, 100))
print("The train set contains", len(train_image_list))

valid_image_list, valid_y_list,valid_image_name = utils.load_images(basedir, 'validation', (100, 100))
print("The valid set contains", len(valid_image_list))

test_image_list, test_y_list,test_image_name = utils.load_images(basedir, 'test', (100, 100))
...
embedding_network = tf.keras.models.load_model(
    "D:\my_code_2\my_code\metacovid-siamese-neural-network-main\metacovid-siamese-neural-network-main\scripts\embedding_network.h5")
